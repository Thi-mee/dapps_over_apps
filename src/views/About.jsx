    ...
    <Page className={style.container}>
      ...
      <div className={style.second__section}>
        ...
        <div className={style.second__section__col}>
          ...
          <div className={style.second__section__col__text}>
            <p>
              We are on a journey to spread the value of Web3 and Decentralized
              Finance across Africa, and beyond. The AFEN ecosystem is
              multi-chain, powered by the $AFEN token, and community driven.
            </p>
            <p>
              We are on a journey to spread the value of Web3 and Decentralized
              Finance across Africa, and beyond. The AFEN ecosystem is
      ...
      <div className={style.third__section__flex}>
        ...
        <p>
          Blockchain has the potential to adequately transform African society.
          Offering insurmountable opportunities to those leveraging it to build
          a new structure in diverse sectors.
        </p>
        ...
        <div className={style.third__section__cols}>
          <div className={style.third__section__col}>
            <h2>Innovation</h2>
            <p>
              We are driven by the passion to reconstruct a new Africa offering
              insurmountable value to the world.
            </p>
          </div>
          <div className={style.third__section__col}>
            <h2>Accountability</h2>
            <p>
              Despite operating within a decentralized industry, we are
              committed to transparency as well as committed to bearing the cost
              of our decisions.
            </p>
          </div>
          <div className={style.third__section__col}>
            ...
            <p>
              dApps over apps is focused on innovating for longevity, use, and
              impact. The short term isn’t in our plans to drive innovation.
            </p>
          </div>
        </div>
      </div>
