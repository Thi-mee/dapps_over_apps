    ...
    <Page className={style.container}>
      ...
      <div className={style.first_section}>
        ...
        <div className={style.ctn_text}>
          ...
          <p>
            Encouraging builder and traditional developers explore the world of
            web 3.0 and "get smart" with blockchain infrastructures
          </p>
          <Button
      ...
      <div className={style.third_section}>
        ...
        <div className={style.third__section__flex}>
          <div>
            <h2>Education</h2>
            <p>
              Educational content available at all times to help you get better
              at using decentralized applications to aid your growth.
            </p>
          </div>
          <div>
            <h2>Education</h2>
